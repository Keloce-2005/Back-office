"""
Django settings for Back_PA project.
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'),  # Ajout du répertoire de templates de niveau projet
            os.path.join(BASE_DIR, 'dashboard', 'templates'),  # Ajout explicite du répertoire de templates de l'application
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
